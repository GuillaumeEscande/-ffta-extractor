...
$cutManager = new ffta_extractor\Cut_manager("CR-occitanie.json");

?>

    <a href="./cut_cr11_2017.php?generate=all">Generer les données</a><br/>
    <a href="./cut_cr11_2017.php?generate=cut">Generer les cuts</a><br/>
    <br/>
...
foreach( $cutManager->get_cut_name_list() as $cutname ){
    echo "      <li>";
    echo "<a href=\"./cut_cr11_2017.php?print=".urlencode($cutname)."\">";
    echo $cutname;
    echo "</a>";
    echo "</li>";
}
